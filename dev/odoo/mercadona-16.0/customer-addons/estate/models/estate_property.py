...
class EstateProperty(models.Model):
    ...
    property_type_id = fields.Many2one("estate_property_type", string="Property Type") # This is a many2one field that will link to the estate_property_type model
    property_tag_ids = fields.Many2many("estate_property_tag", string="Tags") # This is a many2many field that will link to the estate_property_tag model
    ...
    def _selling_price_constraint(self):
        ...
        for property in self:
            if property.selling_price < property.expected_price * 0.9 and not float_utils.float_is_zero(property.selling_price, 6):
